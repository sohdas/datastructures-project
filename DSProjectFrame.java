                    ...
                    if(lt.getMinute()+1 < 60){
                        if(lt.getHour() > 12){
                            if(lt.getMinute()+1<10){
                                 tMed = new Medication(tMed1.getAmtDose(),tMed1.getName(),(lt.getHour()-12)+":"+0+(lt.getMinute()+1)+" PM");
                    tMed.setReminder(true);
                            }
                            else{
                   tMed = new Medication(tMed1.getAmtDose(),tMed1.getName(),(lt.getHour()-12)+":"+(lt.getMinute()+1)+" "+"PM");
                    tMed.setReminder(true);
                            }
                        }
                        else{
                            if(lt.getMinute()+1<10){
                              tMed = new Medication(tMed1.getAmtDose(),tMed1.getName(),(lt.getHour())+":"+0+(lt.getMinute()+1)+" AM");
                    tMed.setReminder(true);
                            }
                            else{
                                  tMed = new Medication(tMed1.getAmtDose(),tMed1.getName(),(lt.getHour())+":"+(lt.getMinute()+1)+" AM");
                    tMed.setReminder(true);
                            }
                        }
                    }
                       ...
                       tMed = new Medication(tMed1.getAmtDose(),tMed1.getName(),((lt.getHour()-12)+1)+":"+0+(60-(lt.getMinute()+1))+" PM");
                    tMed.setReminder(true);
                        }
                        else{
                             tMed = new Medication(tMed1.getAmtDose(),tMed1.getName(),((lt.getHour())+1)+":"+0+(60-(lt.getMinute()+1))+" PM");
                    tMed.setReminder(true);
                        }
                    }
